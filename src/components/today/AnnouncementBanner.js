...
export default function AnnouncementBanner() {
    ...
    const tones = TYPE_COLORS(); const bgs = TYPE_BG();
    const accent = tones[ann.type] || tones.info;

    return (
        <View style={[styles.banner, { backgroundColor: bgs[ann.type] || bgs.info, borderColor: accent }]}>
